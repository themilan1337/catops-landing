            ...
            <ClientOnly>
                <BlurReveal :delay="0.2" :duration="0.75">
                    <h1
                        ...
                        Don’t wait for production to go down. <br> Know <span class="text-amber-500">before</span> it
                        happens.
                    </h1>
                </BlurReveal>
            </ClientOnly>
            <p class="mb-8 text-lg font-normal text-zinc-500 lg:text-xl sm:px-16 xl:px-48 dark:text-zinc-400">CatOps is
            ...
            <section class="bg-white dark:bg-zinc-950 rounded-3xl">
                <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
                    <div class="mx-auto max-w-screen-sm text-center">
                        ...
                        <p class="mb-6 font-light text-zinc-500 dark:text-zinc-400 md:text-lg">Try CatOps Platform for
                            7 days. No
